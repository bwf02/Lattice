...
The Python package is `lattice`; scripts and tests use this package directly.
...
The exporter supports multiple MoE model families. Run prefill and decoding
with the same request and TP settings:
...
LATTICE_REVISION=$(git rev-parse HEAD) \
...
lattice/        Pattern definitions, checkpoint export, runtime adapters
