...
Pruning and evaluation scripts for MosaicMoE sparse MoE accuracy experiments. This directory is initially based on SlideSparse `accuracy_eval`, which adapts [Wanda](https://github.com/locuslab/wanda) and [SparseGPT](https://github.com/IST-DASLab/sparsegpt) with support for arbitrary N:M sparsity patterns and newer model architectures (e.g., Qwen2.5).
